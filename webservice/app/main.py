...
from .api.routers import scenario, feedback, rag, files, logging as logging_router
from .api.routers.v2.router import v2_router
...
async def startup_rag_system():
    ...
    try:
        ...
        if rag_manager:
            ...
            from .core.config_loader import get_data_directory_path
